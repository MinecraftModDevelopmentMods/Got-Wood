...
public class WorldGenApple extends WorldGenAbstractTree {
    ...
    private static final IBlockState DEFAULT_LEAF = BlockRegistry.apple_leaves.getDefaultState().withProperty(BlockWoodLeaves.DECAYABLE, true);
    ...
    public WorldGenApple(boolean bool) {
        this(bool, 4, DEFAULT_TRUNK, DEFAULT_LEAF);
    }

    public WorldGenApple(boolean bool, int height, IBlockState metawood, IBlockState metaleaves) {
        super(bool);
