...
public class WorldGenEbony extends WorldGenAbstractTree
{
    ...
    private static final IBlockState LEAF = BlockRegistry.ebony_leaves.getDefaultState().withProperty(BlockWoodLeaves.DECAYABLE, Boolean.valueOf(true));

    public WorldGenEbony(boolean doBlockNotify)
    {
        super(doBlockNotify);
    }
