...
public class WorldGenYew extends WorldGenAbstractTree
{
	static final IBlockState TRUNK = BlockRegistry.yew_log.getDefaultState();
    private static final IBlockState LEAF = BlockRegistry.yew_leaves.getDefaultState().withProperty(BlockWoodLeaves.DECAYABLE, Boolean.valueOf(true));
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, ((net.minecraft.block.BlockSapling)net.minecraft.init.Blocks.SAPLING));
                ...
                if (isSoil && position.getY() < worldIn.getHeight() - i - 1)
                {
                    ...
                    for (int l1 = 0; l1 < i; ++l1)
                    {
                        ...
                        if (block2.isAir(iblockstate1, worldIn, upN) || block2.isLeaves(iblockstate1, worldIn, upN) || block2 == net.minecraft.init.Blocks.FLOWING_WATER || block2 == net.minecraft.init.Blocks.WATER)
                        {
