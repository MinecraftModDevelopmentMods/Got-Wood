...
{
    private static final IBlockState DEFAULT_TRUNK = BlockRegistry.rubber_log.getDefaultState().withProperty(SappyLog.GENERATED, 1);
    private static final IBlockState DEFAULT_LEAF = BlockRegistry.rubber_leaves.getDefaultState().withProperty(BlockWoodLeaves.DECAYABLE, Boolean.valueOf(true));
