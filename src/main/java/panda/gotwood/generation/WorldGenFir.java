...
{
	private static final IBlockState TRUNK = BlockRegistry.fir_log.getDefaultState();
    private static final IBlockState LEAF = BlockRegistry.fir_leaves.getDefaultState().withProperty(BlockWoodLeaves.DECAYABLE, Boolean.valueOf(true));

    public WorldGenFir(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
