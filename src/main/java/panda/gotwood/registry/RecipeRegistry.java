...
//TODO Eventually move all recipes to JSON files as crafttweaker no longer supports in code recipes in 1.14 and up (Plus they should really be done in JSON post 1.11)
