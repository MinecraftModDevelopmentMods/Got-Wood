...
//TODO Use the EventBusSubscriber system and an object holder class elsewhere (Likely panda.gotwood.api.GWBlocks)
public final class BlockRegistry {
    ...
    public static final Block rubber_log = new BlockSappyLog(WoodMaterials.rubber);
